...
//////////GEO SHADER
   constexpr auto geoShader = "geoShader";
  ...
  shader->attachShaderToProgram( shaderProgram, geoShader );
  ...
  iv.transpose();
  ngl::Light light( ngl::Vec3( -2, 5, 5 ), ngl::Colour( 1, 1, 1, 1 ), ngl::Colour( 1, 1, 1, 1 ), ngl::LightModes::POINTLIGHT );
...
void NGLScene::paintGL() //initialise metaballs + update movement
{
...
//Draw in main sphere
  ...
  prim->createSphere("sphere",0.3f,50.0);
  prim->draw( "sphere" );
